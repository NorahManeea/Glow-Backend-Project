...
router.put('/:discountCodeId',checkAuth,checkRole('ADMIN'),validateObjectId('discountCodeId'), updateDiscountCodeById)
router.delete('/:discountCodeId', checkAuth,checkRole('ADMIN'),validateObjectId('discountCodeId'), deleteDiscountCode)
